...
#paramètres : I_vectors : l'ensemble des vecteurs ; I l'intervalle, et k le nombre d'objets
def seconde_proc(I_vectors, I, k):
    ...
    #programmation dynamique sur la transformée
    P = q7.prog_dyn(k, len(P_vectors), P_vectors)
    #récupération des vecteurs Pareto-optimaux
    pareto_opt = P[k][len(P_vectors)-1]
    #transformée inverse pour avoir les non I-dominés
